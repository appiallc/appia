  ...
  />
      ...
      {isOpen && (
        <div className="md:hidden bg-white text-black px-6 py-4 space-y-4">
          <Link href="/" className="block hover:text-red-500">Everyday AI</Link>
          <Link href="/" className="block hover:text-red-500">Technologies</Link>
          <Link href="/" className="block hover:text-red-500">Services</Link>
          <Link href="/" className="block hover:text-red-500">Industries</Link>
          <Link href="/" className="block hover:text-red-500">About</Link>
          <Link
            href="/contact"
